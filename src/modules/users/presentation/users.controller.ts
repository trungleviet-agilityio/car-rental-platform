...
import { Controller, Get, Post, UseGuards, HttpCode, HttpStatus, Logger } from '@nestjs/common';
...
export class UsersController {
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Activate user account', description: 'Activate user account after KYC verification (Phase 4)' })
  @ApiResponse({ status: 200, description: 'Account activated successfully', type: ActivateAccountResponseDto })
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Get onboarding progress', description: 'Get current onboarding progress and completion status' })
