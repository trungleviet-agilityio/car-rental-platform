...
export class CreateCarsTable1755155741586 implements MigrationInterface {
    name = 'CreateCarsTable1755155741586'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_cars_owner" ON "cars" ("ownerEmail", "ownerPhone")`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_cars_owner"`);
